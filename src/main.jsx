...
import ConsultationPage from './pages/ConsultationForm/ConsultationPage.jsx'; // Import the new form page
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path='/' element={<Layout />}>
      ...
      <Route path='consultation' element={<ConsultationPage />} /> {/* New route added */}
    </Route>
  )
);
